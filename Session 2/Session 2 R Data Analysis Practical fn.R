...
# Importing data: data saved in working directory
 ...
 GSSsubset_df <- read.table("E:/Projects/Session 2/GSSsubset.csv", header=TRUE, sep=",") # Or this code:
 head(GSSsubset_df)
 str(GSSsubset_df)
 names(GSSsubset_df)
 View(GSSsubset_df)
 table(GSSsubset_df)
 summary(GSSsubset_df)
 table(GSSsubset_df$sex)
 table(GSSsubset_df$marital)
 GSSsubset_df$sex <- factor((GSSsubset_df$sex))
 GSSsubset_df$marital<- factor((GSSsubset_df$marital))
 GSSsubset_df <- read.csv("E:/Projects/Session 2/GSSsubset.csv",header=T,as.is=T)
 head(GSSsubset_df)
 
 #Import data from TXT
GSSsubset_txt <- read.delim("E:/Projects/Session 2/GSSsubset.txt", as.is=TRUE, header=T) # Or this code:
 head(GSSsubset_txt)
 View(GSSsubset_txt)
 ...
 library(readxl)
 Soil_composition <- read_excel("E:/Projects/Session 2/Soil_composition.xlsx", sheet = "Sheet1")    
 head(Soil_composition)
View(Soil_composition) 
install.packages("rio")
library(rio)   
DtaDf <- import("E:/Projects/Session 2/census.dta")
View(DtaDf)
...
# install.packages("foreign", dependencies = TRUE)
 ...
 #Examples
library(foreign)
sleep_df <- read.spss("E:/Projects/Session 2/sleep.sav", use.value.label=TRUE, to.data.frame=TRUE)
head(sleep_df)
View(sleep_df)

export(sleep_df, "E:/Projects/Session 2/sleep.csv")
view
?sleep
sleep
require(stats)
